...
<body>
  <div class="container">
    <form action="<?php echo e(route('job.store')); ?>" method="POST">
      ...
      <div class="form-group">
        <label>Perks</label>
        <input type="text" name="job_perks" />
      </div>
...
<?php /**PATH C:\Users\yadav\OneDrive\Documents\Desktop\Laravelandcomposer\mini_project\resources\views/JobPost.blade.php ENDPATH**/ ?>