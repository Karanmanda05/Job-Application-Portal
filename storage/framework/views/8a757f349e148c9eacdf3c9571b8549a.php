...
<body>
  <div class="container">
    ...
    <form action="<?php echo e(route('main.store')); ?>" method="POST" class="main_form" onSubmit="return validatePassword()">
      <?php echo csrf_field(); ?>
      <table>
        <tr>
          <td>Full Name</td>
...
<?php /**PATH C:\Users\yadav\OneDrive\Documents\Desktop\Laravelandcomposer\mini_project\resources\views/Register.blade.php ENDPATH**/ ?>